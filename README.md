...
McsIDE is a native Android Integrated Development Environment (IDE) for web front-end development. Built entirely with Jetpack Compose, this project implements a complete workflow ranging from code editing to building APKs directly on your mobile device.
...
The main code is located in `app/src/main/java/com/scto/mcside/`. The directory structure and functions are as follows:
...
<a href="https://github.com/scto/McsIDE/graphs/contributors">
   <img src="https://contributors-img.web.app/image?repo=scto/McsIDE" />
</a>
